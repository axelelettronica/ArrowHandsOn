...
#define HTVL6180X_ADDRESS     0x29

//Define a few of the registers that we will be accessing on the HTS221
#define WHO_AM_I    0x00
#define WHO_AM_I_RETURN 0xB4 //This read-only register contains the device identifier, set to BCh
...
bool vl6180x_init(void) {
    uint8_t data;
     if (readRegister(HTVL6180X_ADDRESS, WHO_AM_I, &data)) {
