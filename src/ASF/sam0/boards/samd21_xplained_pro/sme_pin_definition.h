...
//
/*
#define SME_CDC_MODULE              SERCOM5
#define SME_CDC_SERCOM_MUX_SETTING  USART_RX_3_TX_2_XCK_3
#define SME_CDC_SERCOM_PINMUX_PAD0  PINMUX_PA20C_SERCOM5_PAD2
#define SME_CDC_SERCOM_PINMUX_PAD1  PINMUX_PA21C_SERCOM5_PAD3
#define SME_CDC_SERCOM_PINMUX_PAD2  PINMUX_UNUSED
#define SME_CDC_SERCOM_PINMUX_PAD3  PINMUX_UNUSED
#define SME_CDC_SERCOM_DMAC_ID_TX   SERCOM5_DMAC_ID_TX
#define SME_CDC_SERCOM_DMAC_ID_RX   SERCOM5_DMAC_ID_RX*/
#else
